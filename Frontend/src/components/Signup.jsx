    ...
    <>
      <div className="flex h-screen items-center justify-center bg-[var(--bg-primary)]">
        <form
          ...
          className="border border-[var(--border-subtle)] px-6 py-4 rounded-2xl space-y-3 w-96 bg-[var(--card-bg)] shadow-xl mt-4 max-h-[95vh] overflow-y-auto custom-scrollbar"
        >
          <div className="flex flex-col items-center gap-1 mb-2">
            <img src={logo} alt="CircleUp Logo" className="w-12 h-12" />
            <h1 className="text-2xl font-bold text-[var(--accent-primary)]">
              CircleUp
            </h1>
          </div>
          <h2 className="text-lh text-[var(--text-secondary)] font-medium text-center">Create Account</h2>

          {/* Profile Picture Upload */}
          <div className="flex flex-col items-center gap-2 mb-4">
            <div
              className="w-16 h-16 rounded-full overflow-hidden border-2 bg-gray-700 flex items-center justify-center relative group cursor-pointer"
            ...
            <span className="text-xs text-[var(--text-secondary)]">Upload Profile Picture</span>
          </div>
